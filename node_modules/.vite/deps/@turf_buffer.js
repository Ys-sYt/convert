...
function coordEach(geojson, callback, excludeWrapCoord) {
  if (geojson === null)
    return;
  var j, k, l, geometry, stopG, coords, geometryMaybeCollection, wrapShrink = 0, coordIndex = 0, isGeometryCollection2, type = geojson.type, isFeatureCollection = type === "FeatureCollection", isFeature = type === "Feature", stop = isFeatureCollection ? geojson.features.length : 1;
...
function geomEach(geojson, callback) {
  var i, j, g, geometry, stopG, geometryMaybeCollection, isGeometryCollection2, featureProperties, featureBBox, featureId, featureIndex = 0, isFeatureCollection = geojson.type === "FeatureCollection", isFeature = geojson.type === "Feature", stop = isFeatureCollection ? geojson.features.length : 1;
  for (i = 0; i < stop; i++) {
...
MathUtil.wrap = function wrap(index, max3) {
  if (index < 0) {
    return max3 - -index % max3;
  }
  return index % max3;
};
...
DD.prototype.min = function min2(x) {
  if (this.le(x)) {
    return this;
  } else {
    return x;
...
DD.prototype.max = function max2(x) {
  if (this.ge(x)) {
    return this;
  } else {
    return x;
...
DD.parse = function parse(str) {
  ...
  if (numDecPlaces === 0) {
    ...
    var scale3 = DD.TEN.pow(numDecPlaces);
    val2 = val.divide(scale3);
  } else if (numDecPlaces < 0) {
...
CGAlgorithmsDD.signum = function signum2(x) {
  if (x > 0) {
    return 1;
  }
  if (x < 0) {
...
CoordinateSequence.prototype.setOrdinate = function setOrdinate2(index, ordinateIndex, value) {
};
CoordinateSequence.prototype.size = function size() {
};
CoordinateSequence.prototype.getOrdinate = function getOrdinate2(index, ordinateIndex) {
};
...
HCoordinate.intersection = function intersection2(p1, p2, q1, q2) {
  var px = p1.y - p2.y;
  var py = p2.x - p1.x;
...
Envelope.prototype.equals = function equals3(other) {
...
Envelope.prototype.intersection = function intersection3(env) {
...
Envelope.prototype.expandBy = function expandBy() {
  if (arguments.length === 1) {
    var distance10 = arguments[0];
    this.expandBy(distance10, distance10);
  } else if (arguments.length === 2) {
...
var parse$1 = {
  ...
  multipoint: function multipoint2(str) {
    ...
    for (var i = 0, len = points.length; i < len; ++i) {
      point4 = points[i].replace(regExes.trimParens, "$1");
  ...
  multipolygon: function multipolygon2(str) {
    ...
    for (var i = 0, len = polygons.length; i < len; ++i) {
      polygon3 = polygons[i].replace(regExes.trimParens, "$1");
      components.push(parse$1.polygon.apply(this$1, [polygon3]));
    }
...
WKTWriter.prototype.write = function write2(geometry) {
...
Assert.equals = function equals4() {
  var expectedValue;
  var actualValue;
  var message;
  if (arguments.length === 2) {
...
var RobustLineIntersector = function(LineIntersector$$1) {
  ...
  RobustLineIntersector2.prototype.intersection = function intersection8(p1, p2, q1, q2) {
...
CGAlgorithms.orientationIndex = function orientationIndex3(p1, p2, q) {
...
Geometry.prototype.equals = function equals5() {
...
var ArrayList = function(List$$1) {
  ...
  ArrayList2.prototype.get = function get4(index) {
...
var CoordinateList = function(ArrayList$$1) {
  ...
  CoordinateList2.prototype.clone = function clone5() {
    var this$1 = this;
    var clone6 = ArrayList$$1.prototype.clone.call(this);
    for (var i = 0; i < this.size(); i++) {
      clone6.add(i, this$1.get(i).copy());
    }
    return clone6;
  };
...
CoordinateArrays.equals = function equals6() {
  if (arguments.length === 2) {
...
CoordinateArrays.intersection = function intersection4(coordinates, env) {
...
var GeometryCollection = function(Geometry$$1) {
  ...
  GeometryCollection2.prototype.computeEnvelopeInternal = function computeEnvelopeInternal() {
    ...
    for (var i = 0; i < this._geometries.length; i++) {
      envelope2.expandToInclude(this$1._geometries[i].getEnvelopeInternal());
    }
    return envelope2;
  };
  ...
  GeometryCollection2.prototype.getArea = function getArea3() {
    ...
    var area4 = 0;
    for (var i = 0; i < this._geometries.length; i++) {
      area4 += this$1._geometries[i].getArea();
    }
    return area4;
  };
  ...
  GeometryCollection2.prototype.normalize = function normalize4() {
    var this$1 = this;
    for (var i = 0; i < this._geometries.length; i++) {
  ...
  GeometryCollection2.prototype.reverse = function reverse4() {
    var this$1 = this;
  ...
  GeometryCollection2.prototype.clone = function clone5() {
    var this$1 = this;
...
var MultiLineString = function(GeometryCollection$$1) {
  ...
  MultiLineString2.prototype.reverse = function reverse4() {
    var this$1 = this;
...
CoordinateSequences.copy = function copy4(src, srcPos, dest, destPos, length) {
...
var LineString = function(Geometry$$1) {
  ...
  LineString2.prototype.normalize = function normalize4() {
    var this$1 = this;
  ...
  LineString2.prototype.reverse = function reverse4() {
  ...
  LineString2.prototype.clone = function clone5() {
  ...
  LineString2.prototype.copy = function copy7() {
  ...
  LineString2.prototype.init = function init8(points) {
    if (points === null) {
...
var Point = function(Geometry$$1) {
  ...
  Point2.prototype.normalize = function normalize4() {
  };
  ...
  Point2.prototype.reverse = function reverse4() {
    return this.copy();
  };
  ...
  Point2.prototype.clone = function clone5() {
...
var Polygon = function(Geometry$$1) {
  ...
  Polygon2.prototype.getArea = function getArea3() {
    var this$1 = this;
    var area4 = 0;
    area4 += Math.abs(CGAlgorithms.signedArea(this._shell.getCoordinateSequence()));
    for (var i = 0; i < this._holes.length; i++) {
      area4 -= Math.abs(CGAlgorithms.signedArea(this$1._holes[i].getCoordinateSequence()));
    }
    return area4;
  };
  ...
  Polygon2.prototype.normalize = function normalize4() {
    var this$1 = this;
    if (arguments.length === 0) {
  ...
  Polygon2.prototype.reverse = function reverse4() {
    var this$1 = this;
    var poly = this.copy();
  ...
  Polygon2.prototype.clone = function clone5() {
    var this$1 = this;
...
var LinearRing = function(LineString$$1) {
  ...
  LinearRing2.prototype.reverse = function reverse4() {
    var seq = this._points.copy();
    CoordinateSequences.reverse(seq);
...
var MultiPolygon = function(GeometryCollection$$1) {
  ...
  MultiPolygon2.prototype.reverse = function reverse4() {
    var this$1 = this;
    var n = this._geometries.length;
    var revGeoms = new Array(n).fill(null);
    for (var i = 0; i < this._geometries.length; i++) {
  ...
  MultiPolygon2.prototype.getBoundary = function getBoundary3() {
    ...
    for (var i = 0; i < this._geometries.length; i++) {
      var polygon3 = this$1._geometries[i];
      var rings = polygon3.getBoundary();
...
GeometryEditor.prototype.editPolygon = function editPolygon(polygon3, operation) {
  var this$1 = this;
  var newPolygon = operation.edit(polygon3, this._factory);
  if (newPolygon === null) {
...
NoOpGeometryOperation.prototype.edit = function edit2(geometry, factory) {
  return geometry;
};
...
CoordinateOperation.prototype.edit = function edit3(geometry, factory) {
...
CoordinateSequenceOperation.prototype.edit = function edit4(geometry, factory) {
  if (geometry instanceof LinearRing) {
...
CoordinateArraySequence.prototype.setOrdinate = function setOrdinate3(index, ordinateIndex, value) {
  switch (ordinateIndex) {
...
CoordinateArraySequence.prototype.getOrdinate = function getOrdinate3(index, ordinateIndex) {
  switch (ordinateIndex) {
    case CoordinateSequence.X:
...
CoordinateArraySequence.prototype.getX = function getX3(index) {
  return this._coordinates[index].x;
};
...
CoordinateArraySequence.prototype.getY = function getY3(index) {
  return this._coordinates[index].y;
};
...
var PrecisionModel = function PrecisionModel2() {
  ...
  if (arguments.length === 0) {
    ...
    if (arguments[0] instanceof Type) {
      ...
      var scale3 = arguments[0];
      this._modelType = PrecisionModel2.FIXED;
      this.setScale(scale3);
...
PrecisionModel.prototype.equals = function equals7(other) {
...
PrecisionModel.prototype.setScale = function setScale(scale3) {
  this._scale = Math.abs(scale3);
};
...
GeoJSONParser.prototype.write = function write3(geometry) {
  var type = geometry.getGeometryType();
  if (!extract2[type]) {
    throw new Error("Geometry is not supported");
  }
  return extract2[type].apply(this, [geometry]);
};
var parse2 = {
  /**
  ...
  MultiPoint: function(array2) {
    ...
    var points = [];
    for (var i = 0; i < array2.length; ++i) {
      points.push(parse2.Point.apply(this$1, [array2[i]]));
    }
  ...
  MultiLineString: function(array2) {
    ...
    var lineStrings = [];
    for (var i = 0; i < array2.length; ++i) {
      lineStrings.push(parse2.LineString.apply(this$1, [array2[i]]));
    }
  ...
  MultiPolygon: function(array2) {
    ...
    var polygons = [];
    for (var i = 0; i < array2.length; ++i) {
      var polygon3 = array2[i];
      polygons.push(parse2.Polygon.apply(this$1, [polygon3]));
    }
...
var extract2 = {
   ...
   */
  Polygon: function(polygon3) {
    var this$1 = this;
    var array2 = [];
    var shellGeoJson = extract2.LineString.apply(this, [polygon3._shell]);
    array2.push(shellGeoJson.coordinates);
    for (var i = 0; i < polygon3._holes.length; ++i) {
      var hole = polygon3._holes[i];
  ...
  MultiPolygon: function(multipolygon3) {
    ...
    for (var i = 0; i < multipolygon3._geometries.length; ++i) {
      var polygon3 = multipolygon3._geometries[i];
      var geoJson = extract2.Polygon.apply(this$1, [polygon3]);
      array2.push(geoJson.coordinates);
    }
    return {
      type: "MultiPolygon",
  ...
  GeometryCollection: function(collection) {
    ...
    for (var i = 0; i < collection._geometries.length; ++i) {
      ...
      var type = geometry.getGeometryType();
      array2.push(extract2[type].apply(this$1, [geometry]));
    }
    return {
...
GeoJSONWriter.prototype.write = function write4(geometry) {
  return this.parser.write(geometry);
};
...
Label.prototype.flip = function flip2() {
  this.elt[0].flip();
  this.elt[1].flip();
};
...
var Node = function(GraphComponent$$1) {
  ...
  if (GraphComponent$$1)
    Node2.__proto__ = GraphComponent$$1;
  ...
  Node2.prototype.isIsolated = function isIsolated2() {
    return this._label.getGeometryCount() === 1;
  };
  Node2.prototype.getCoordinate = function getCoordinate18() {
    return this._coord;
  };
  Node2.prototype.print = function print9(out) {
  ...
  Node2.prototype.setLabel = function setLabel2() {
    if (arguments.length === 2) {
  ...
  Node2.prototype.getEdges = function getEdges4() {
    return this._edges;
  };
  Node2.prototype.mergeLabel = function mergeLabel2() {
    var this$1 = this;
  ...
  Node2.prototype.add = function add16(e) {
  ...
  Node2.prototype.interfaces_ = function interfaces_170() {
    return [];
  };
  Node2.prototype.getClass = function getClass169() {
    return Node2;
  };
  return Node2;
}(GraphComponent);
...
NodeMap.prototype.add = function add4(e) {
...
EdgeEnd.prototype.print = function print2(out) {
  var angle3 = Math.atan2(this._dy, this._dx);
  var className = this.getClass().getName();
  var lastDotPos = className.lastIndexOf(".");
  var name = className.substring(lastDotPos + 1);
  out.print("  " + name + ": " + this._p0 + " - " + this._p1 + " " + this._quadrant + ":" + angle3 + "   " + this._label);
};
...
EdgeEnd.prototype.toString = function toString13() {
  ...
  var lastDotPos = className.lastIndexOf(".");
  var name = className.substring(lastDotPos + 1);
  return "  " + name + ": " + this._p0 + " - " + this._p1 + " " + this._quadrant + ":" + angle3 + "   " + this._label;
};
...
PlanarGraph.prototype.add = function add5(e) {
  this._nodes.add(e);
...
PriorityQueue.prototype.add = function add7(x) {
  var this$1 = this;
  this._items.add(null);
  this._size += 1;
  var hole = this._size;
...
LineSegment.prototype.orientationIndex = function orientationIndex4() {
...
LineSegment.prototype.equals = function equals8(o) {
...
LineSegment.prototype.intersection = function intersection5(line) {
...
BufferInputLineSimplifier.simplify = function simplify2(inputLine, distanceTol) {
...
Angle.normalize = function normalize2(angle3) {
  while (angle3 > Math.PI) {
    angle3 -= Angle.PI_TIMES_2;
  }
  while (angle3 <= -Math.PI) {
    angle3 += Angle.PI_TIMES_2;
  }
...
Angle.normalizePositive = function normalizePositive(angle3) {
  if (angle3 < 0) {
    while (angle3 < 0) {
      angle3 += Angle.PI_TIMES_2;
    }
    if (angle3 >= Angle.PI_TIMES_2) {
      angle3 = 0;
    }
  } else {
    while (angle3 >= Angle.PI_TIMES_2) {
      angle3 -= Angle.PI_TIMES_2;
    }
    if (angle3 < 0) {
      angle3 = 0;
...
OffsetSegmentGenerator.prototype.addLineEndCap = function addLineEndCap(p0, p1) {
  ...
  switch (this._bufParams.getEndCapStyle()) {
    case BufferParameters.CAP_ROUND:
      ...
      this.addFilletArc(p1, angle3 + Math.PI / 2, angle3 - Math.PI / 2, CGAlgorithms.CLOCKWISE, this._distance);
    ...
    case BufferParameters.CAP_SQUARE:
      ...
      squareCapSideOffset.x = Math.abs(this._distance) * Math.cos(angle3);
      squareCapSideOffset.y = Math.abs(this._distance) * Math.sin(angle3);
...
OffsetSegmentGenerator.prototype.addMitreJoin = function addMitreJoin(p, offset0, offset1, distance10) {
  var isMitreWithinLimit = true;
  var intPt = null;
  try {
    intPt = HCoordinate.intersection(offset0.p0, offset0.p1, offset1.p0, offset1.p1);
    var mitreRatio = distance10 <= 0 ? 1 : intPt.distance(p) / Math.abs(distance10);
  ...
  if (isMitreWithinLimit) {
    ...
    this.addLimitedMitreJoin(offset0, offset1, distance10, this._bufParams.getMitreLimit());
  }
};
...
OffsetSegmentGenerator.prototype.addLimitedMitreJoin = function addLimitedMitreJoin(offset0, offset1, distance10, mitreLimit) {
  ...
  var mitreDist = mitreLimit * distance10;
  var bevelDelta = mitreDist * Math.abs(Math.sin(angDiffHalf));
  var bevelHalfLen = distance10 - bevelDelta;
...
OffsetSegmentGenerator.prototype.computeOffsetSegment = function computeOffsetSegment(seg, side, distance10, offset) {
  var sideSign = side === Position.LEFT ? 1 : -1;
  var dx = seg.p1.x - seg.p0.x;
  var dy = seg.p1.y - seg.p0.y;
  var len = Math.sqrt(dx * dx + dy * dy);
  var ux = sideSign * distance10 * dx / len;
  var uy = sideSign * distance10 * dy / len;
...
OffsetSegmentGenerator.prototype.addFilletArc = function addFilletArc(p, startAngle, endAngle, direction, radius) {
  ...
  while (currAngle < totalAngle) {
    var angle3 = startAngle + directionFactor * currAngle;
    pt.x = p.x + radius * Math.cos(angle3);
    pt.y = p.y + radius * Math.sin(angle3);
...
OffsetSegmentGenerator.prototype.init = function init5(distance10) {
  this._distance = distance10;
  this._maxCurveSegmentError = distance10 * (1 - Math.cos(this._filletAngleQuantum / 2));
  this._segList = new OffsetSegmentString();
  this._segList.setPrecisionModel(this._precisionModel);
  this._segList.setMinimumVertexDistance(distance10 * OffsetSegmentGenerator.CURVE_VERTEX_SNAP_DISTANCE_FACTOR);
};
...
OffsetCurveBuilder.prototype.getOffsetCurve = function getOffsetCurve(inputPts, distance10) {
  this._distance = distance10;
  if (distance10 === 0) {
    return null;
  }
  var isRightSide = distance10 < 0;
  var posDistance = Math.abs(distance10);
...
OffsetCurveBuilder.prototype.getLineCurve = function getLineCurve(inputPts, distance10) {
  this._distance = distance10;
  if (distance10 < 0 && !this._bufParams.isSingleSided()) {
    return null;
  }
  if (distance10 === 0) {
    return null;
...
OffsetCurveBuilder.prototype.getRingCurve = function getRingCurve(inputPts, side, distance10) {
  this._distance = distance10;
  if (inputPts.length <= 2) {
    return this.getLineCurve(inputPts, distance10);
  }
  if (distance10 === 0) {
    return OffsetCurveBuilder.copyCoordinates(inputPts);
  }
  var segGen = this.getSegGen(distance10);
...
OffsetCurveBuilder.prototype.getSegGen = function getSegGen(distance10) {
  return new OffsetSegmentGenerator(this._precisionModel, this._bufParams, distance10);
};
...
Triangle.prototype.area = function area2() {
  return Triangle.area(this.p0, this.p1, this.p2);
};
Triangle.prototype.signedArea = function signedArea2() {
...
Triangle.prototype.isAcute = function isAcute2() {
...
Triangle.prototype.interfaces_ = function interfaces_91() {
  return [];
};
Triangle.prototype.getClass = function getClass90() {
  return Triangle;
};
Triangle.area = function area3(a, b, c) {
  return Math.abs(((c.x - a.x) * (b.y - a.y) - (b.x - a.x) * (c.y - a.y)) / 2);
};
Triangle.signedArea = function signedArea3(a, b, c) {
  return ((c.x - a.x) * (b.y - a.y) - (b.x - a.x) * (c.y - a.y)) / 2;
};
Triangle.det = function det(m00, m01, m10, m11) {
  return m00 * m11 - m01 * m10;
};
Triangle.interpolateZ = function interpolateZ2(p, v0, v1, v2) {
  var x02 = v0.x;
  var y02 = v0.y;
  var a = v1.x - x02;
  var b = v2.x - x02;
...
Triangle.longestSideLength = function longestSideLength2(a, b, c) {
...
Triangle.isAcute = function isAcute3(a, b, c) {
...
Triangle.circumcentre = function circumcentre2(a, b, c) {
  var cx = c.x;
  var cy = c.y;
  var ax = a.x - cx;
  var ay = a.y - cy;
...
Triangle.area3D = function area3D2(a, b, c) {
  var ux = b.x - a.x;
  var uy = b.y - a.y;
  var uz = b.z - a.z;
  var vx = c.x - a.x;
...
Triangle.centroid = function centroid2(a, b, c) {
  var x = (a.x + b.x + c.x) / 3;
  var y = (a.y + b.y + c.y) / 3;
  return new Coordinate(x, y);
};
Triangle.inCentre = function inCentre2(a, b, c) {
...
EdgeList.prototype.add = function add10(e) {
  this._edges.add(e);
  var oca = new OrientedCoordinateArray(e.getCoordinates());
...
EdgeIntersectionList.prototype.add = function add11(intPt, segmentIndex, dist) {
...
var Edge = function(GraphComponent$$1) {
  ...
  Edge2.prototype.equals = function equals9(o) {
    var this$1 = this;
  ...
  Edge2.prototype.print = function print9(out) {
    var this$1 = this;
  ...
  Edge2.prototype.toString = function toString25() {
    var this$1 = this;
    var buf = new StringBuffer();
...
BufferBuilder.prototype.buffer = function buffer(g, distance10) {
  ...
  var curveSetBuilder = new OffsetCurveSetBuilder(g, distance10, curveBuilder);
...
HotPixel.prototype.intersectsScaled = function intersectsScaled(p0, p1) {
  ...
  var intersects6 = this.intersectsToleranceSquare(p0, p1);
  Assert.isTrue(!(isOutsidePixelEnv && intersects6), "Found bad envelope test");
  return intersects6;
};
...
HotPixel.prototype.intersects = function intersects3(p0, p1) {
...
BufferOp.prototype.getResultGeometry = function getResultGeometry(distance10) {
  this._distance = distance10;
...
BufferOp.bufferOp = function bufferOp() {
  if (arguments.length === 2) {
    ...
    var geomBuf = gBuf.getResultGeometry(distance10);
    return geomBuf;
  } else if (arguments.length === 3) {
...
BufferOp.precisionScaleFactor = function precisionScaleFactor(g, distance10, maxPrecisionDigits) {
  var env = g.getEnvelopeInternal();
  var envMax = MathUtil.max(Math.abs(env.getMaxX()), Math.abs(env.getMaxY()), Math.abs(env.getMinX()), Math.abs(env.getMinY()));
  var expandByDistance = distance10 > 0 ? distance10 : 0;
...
MaxMidpointDistanceFilter.prototype.filter = function filter7(seq, index) {
  if (index === 0) {
    return null;
  }
...
PointLocator.prototype.intersects = function intersects4(p, geom) {
...
DistanceOp.prototype.updateMinDistance = function updateMinDistance(locGeom, flip3) {
  if (locGeom[0] === null) {
    return null;
  }
  if (flip3) {
...
DistanceOp.isWithinDistance = function isWithinDistance(g0, g1, distance10) {
  var distOp = new DistanceOp(g0, g1, distance10);
  return distOp.distance() <= distance10;
};
...
MaxDensifiedByFractionDistanceFilter.prototype.filter = function filter13(seq, index) {
  var this$1 = this;
  if (index === 0) {
    return null;
  }
...
var BufferResultValidator = function BufferResultValidator2(input, distance10, result) {
  this._isValid = true;
  this._errorMsg = null;
  this._errorLocation = null;
  this._errorIndicator = null;
  this._input = input || null;
  this._distance = distance10 || null;
  this._result = result || null;
};
...
BufferResultValidator.isValidMsg = function isValidMsg(g, distance10, result) {
  var validator = new BufferResultValidator(g, distance10, result);
  if (!validator.isValid()) {
    return validator.getErrorMessage();
  }
  return null;
};
BufferResultValidator.isValid = function isValid3(g, distance10, result) {
  var validator = new BufferResultValidator(g, distance10, result);
  if (validator.isValid()) {
    return true;
  }
...
BasicSegmentString.prototype.getSegmentOctant = function getSegmentOctant2(index) {
  if (index === this._pts.length - 1) {
    return -1;
  }
...
EdgeNodingValidator.checkValid = function checkValid4(edges) {
...
SnapOverlayOp.intersection = function intersection6(g0, g1) {
...
SnapIfNeededOverlayOp.union = function union2(g0, g1) {
  return SnapIfNeededOverlayOp.overlayOp(g0, g1, OverlayOp.UNION);
};
SnapIfNeededOverlayOp.intersection = function intersection7(g0, g1) {
...
IntervalRTreeNode.prototype.intersects = function intersects5(queryMin, queryMax) {
...
GeometryCombiner.combine = function combine2() {
  if (arguments.length === 1) {
    var geoms = arguments[0];
...
CascadedPolygonUnion.prototype.union = function union3() {
  if (this._inputPolys === null) {
...
CascadedPolygonUnion.prototype.unionTree = function unionTree(geomTree) {
  ...
  var union6 = this.binaryUnion(geoms);
  return union6;
};
CascadedPolygonUnion.prototype.unionUsingEnvelopeIntersection = function unionUsingEnvelopeIntersection(g0, g1, common) {
  ...
  var union6 = this.unionActual(g0Int, g1Int);
  disjointPolys.add(union6);
...
CascadedPolygonUnion.getGeometry = function getGeometry2(list, index) {
  if (index >= list.size()) {
    return null;
  }
  return list.get(index);
};
CascadedPolygonUnion.union = function union4(polys) {
...
UnionOp.union = function union5(g, other) {
  if (g.isEmpty() || other.isEmpty()) {
    if (g.isEmpty() && other.isEmpty()) {
...
function pointEqual_default(a, b) {
  return abs2(a[0] - b[0]) < epsilon && abs2(a[1] - b[1]) < epsilon;
}

// node_modules/d3-geo/src/clip/polygon.js
function Intersection(point4, points, other, entry) {
  this.x = point4;
  this.z = points;
  this.o = other;
  this.e = entry;
...
function polygon_default(segments, compareIntersection2, startInside, interpolate, stream) {
  ...
  var start = subject[0], points, point4;
  while (1) {
      ...
      if (current.e) {
        if (isSubject) {
          for (i = 0, n = points.length; i < n; ++i)
            stream.point((point4 = points[i])[0], point4[1]);
        } else {
...
function clipExtent(x02, y02, x12, y12) {
  ...
  function corner(p, direction) {
    return abs2(p[0] - x02) < epsilon ? direction > 0 ? 0 : 3 : abs2(p[0] - x12) < epsilon ? direction > 0 ? 2 : 1 : abs2(p[1] - y02) < epsilon ? direction > 0 ? 1 : 0 : direction > 0 ? 3 : 2;
  }
  ...
  return function(stream) {
    var activeStream = stream, bufferStream = buffer_default(), segments, polygon3, ring, x__, y__, v__, x_, y_, v_, first, clean;
    var clipStream = {
      point: point4,
      lineStart,
      lineEnd,
    ...
    function polygonInside() {
      var winding = 0;
      for (var i = 0, n = polygon3.length; i < n; ++i) {
        for (var ring2 = polygon3[i], j = 1, m = ring2.length, point5 = ring2[0], a0, a1, b0 = point5[0], b1 = point5[1]; j < m; ++j) {
    ...
    function polygonStart() {
      activeStream = bufferStream, segments = [], polygon3 = [], clean = true;
    }
    function polygonEnd() {
      ...
      activeStream = stream, segments = polygon3 = ring = null;
    }
    function lineStart() {
...
function polygonContains_default(polygon3, point4) {
  var lambda = point4[0], phi = point4[1], normal = [sin(lambda), -cos(lambda), 0], angle3 = 0, winding = 0;
  sum.reset();
  for (var i = 0, n = polygon3.length; i < n; ++i) {
    if (!(m = (ring = polygon3[i]).length))
      continue;
    ...
    for (var j = 0; j < m; ++j, lambda0 = lambda1, sinPhi0 = sinPhi1, cosPhi0 = cosPhi1, point0 = point1) {
      ...
      angle3 += antimeridian ? delta + sign2 * tau : delta;
      if (antimeridian ^ lambda0 >= lambda ^ lambda1 >= lambda) {
        var arc = cartesianCross(cartesian(point0), cartesian(point1));
        cartesianNormalizeInPlace(arc);
        var intersection8 = cartesianCross(normal, arc);
        cartesianNormalizeInPlace(intersection8);
        var phiArc = (antimeridian ^ delta >= 0 ? -1 : 1) * asin(intersection8[2]);
  ...
  return (angle3 < -epsilon || angle3 < epsilon && sum < -epsilon) ^ winding & 1;
}
...
function clip_default(pointVisible, clipLine, interpolate, start) {
  return function(rotate, sink) {
    var line = clipLine(sink), rotatedStart = rotate.invert(start[0], start[1]), ringBuffer = buffer_default(), ringSink = clipLine(ringBuffer), polygonStarted = false, polygon3, segments, ring;
    var clip = {
      point: point4,
      lineStart,
      lineEnd,
      ...
      polygonEnd: function() {
        ...
        var startInside = polygonContains_default(polygon3, rotatedStart);
        if (segments.length) {
          if (!polygonStarted)
...
function circle_default(radius, delta) {
  var cr = cos(radius), smallRadius = cr > 0, notHemisphere = abs2(cr) > epsilon;
  function interpolate(from, to, direction, stream) {
...
function resample(project2, delta2) {
  function resampleLineTo(x02, y02, lambda0, a0, b0, c0, x12, y12, lambda1, a1, b1, c1, depth2, stream) {
    ...
    if (d2 > 4 * delta2 && depth2--) {
      var a = a0 + a1, b = b0 + b1, c = c0 + c1, m = sqrt3(a * a + b * b + c * c), phi2 = asin(c /= m), lambda2 = abs2(abs2(c) - 1) < epsilon || abs2(lambda0 - lambda1) < epsilon ? (lambda0 + lambda1) / 2 : atan2(b, a), p = project2(lambda2, phi2), x2 = p[0], y2 = p[1], dx2 = x2 - x02, dy2 = y2 - y02, dz = dy * dx2 - dx * dy2;
...
function projectionMutator(projectAt) {
  var project2, k = 150, x = 480, y = 250, dx, dy, lambda = 0, phi = 0, deltaLambda = 0, deltaPhi = 0, deltaGamma = 0, rotate, projectRotate, theta = null, preclip = antimeridian_default, x02 = null, y02, x12, y12, postclip = identity_default2, delta2 = 0.5, projectResample = resample_default(projectTransform, delta2), cache, cacheStream;
  ...
  function projectTransform(x2, y2) {
    return x2 = project2(x2, y2), [x2[0] * k + dx, dy - x2[1] * k];
  }
...
function azimuthalInvert(angle3) {
  return function(x, y) {
    var z = sqrt3(x * x + y * y), c = angle3(z), sc = sin(c), cc = cos(c);
    return [
      atan2(x * sc, z * cc),
      asin(z && y * sc / z)
    ];
...
function bufferFeature(geojson, radius, units, steps) {
  ...
  var distance10 = radiansToLength(lengthToRadians(radius, units), "meters");
  var buffered = BufferOp.bufferOp(geom, distance10, steps);
