...
var require_togeojson = __commonJS({
  "node_modules/@mapbox/togeojson/togeojson.js"(exports, module) {
    var toGeoJSON = function() {
      ...
      if (typeof XMLSerializer !== "undefined") {
        ...
        if (typeof exports === "object" && (isNodeEnv || isTitaniumEnv)) {
          serializer = new (require_lib()).XMLSerializer();
        } else {
      ...
      var t = {
        kml: function(doc) {
          var gj = fc(), styleIndex = {}, styleByHash = {}, styleMapIndex = {}, geotypes = ["Polygon", "LineString", "Point", "Track", "gx:Track"], placemarks = get(doc, "Placemark"), styles = get(doc, "Style"), styleMaps = get(doc, "StyleMap");
        ...
        gpx: function(doc) {
          ...
          function getLineStyle(extensions) {
            ...
            if (extensions) {
              ...
              if (lineStyle) {
                var color = nodeVal(get1(lineStyle, "color")), opacity = parseFloat(nodeVal(get1(lineStyle, "opacity"))), width = parseFloat(nodeVal(get1(lineStyle, "width")));
                if (color)
                  style.stroke = color;
                if (!isNaN(opacity))
          ...
          function getProperties(node) {
            var prop = getMulti(node, ["name", "cmt", "desc", "type", "time", "keywords"]), links = get(node, "link");
            if (links.length)
              prop.links = [];
            for (var i2 = 0, link; i2 < links.length; i2++) {
              link = { href: attr(links[i2], "href") };
              extend(link, getMulti(links[i2], ["text", "type"]));
...
export default require_togeojson();
//# sourceMappingURL=@mapbox_togeojson.js.map
